...
def get_weather() -> dict:
    ...
    if req.status_code == 200:
        ...
        for div in soup.find_all("div", class_=div_class):
            ...
            weather_description = div.find("div", class_=weather_decription_class).text
            ...
            min_temp = min_temp_max_temp.split("Max:")[0].strip("Min: ")  # 15 ˚C
            max_temp = min_temp_max_temp.split("Max:")[1].strip(" ")  # 27 ˚C

            weather.append(
                {
                    "city": town_name.strip().replace("\n", ""),
